    ...
    <div className='popup' ref={popupRef}>
      ...
      <input type="text" className="popup__yearly-input" id='yearly' required defaultValue={goal.yearly} onChange={(e) => {
        ...
        <label htmlFor="habit1" className="popup__habit1">
          Habit 1
        <input type="text" className="popup__habit1-input" id='habit1' required defaultValue={goal.habit1} onChange={(e) => {
            e.preventDefault();
        ...
        <label htmlFor="habit2" className="popup__habit2" >
          Habit 2
        <input type="text" className="popup__habit2-input" id='habit2' required defaultValue={goal.habit2} onChange={(e) => {
            e.preventDefault();
        ...
        <label htmlFor="habit3" className="popup__habit3">
          Habit 3
        <input type="text" className="popup__habit3-input" id='habit3' required defaultValue={goal.habit3} onChange={(e) => {
            e.preventDefault();
